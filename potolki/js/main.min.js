!function(a) {
    ...
    a.mask = {
        ...
        caret: function(a, b) {
            ...
            this.each(function() {
                this.setSelectionRange ? this.setSelectionRange(a, b) : this.createTextRange && ((c = this.createTextRange()).collapse(!0), 
        ...
        mask: function(c, g) {
            var h, i, j, k, l, m, n, o;
            if (!c && this.length > 0) {
                var p = (h = a(this[0])).data(a.mask.dataName);
                return p ? p() : void 0;
            }
            return g = a.extend({
                ...
                function w(a) {
                    if (!B.prop("readonly")) {
                        ...
                        (e = b.end) - c == 0 && (c = 46 !== f ? r(c) : e = q(c - 1), e = 46 === f ? q(e) : e), 
    ...
    }), $("input[type='tel']").mask("+7 (999) 999-99-99"), $.mask.definitions["~"] = "([0-9])?", 
    $("input[type='text']").mask("~~~", {
        placeholder: " "
    }), $("#free").submit(function(event) {
        event.preventDefault();
        var data = $(this).serialize(), posting = $.post("php/mail.php", {
            data: data
        });
